...
class Train_cyclegan():
	...
	batch_size = 2 # set 5 when use Semantic loss
	...
	semantic_loss_lambda = 1.0 # only used if us use_semantic_loss = True
	diff_loss_lambda = 0.0 # only used if use_diff_loss = True
