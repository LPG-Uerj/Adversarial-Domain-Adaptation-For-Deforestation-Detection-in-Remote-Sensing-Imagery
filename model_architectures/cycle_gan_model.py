...
class CycleGANModel(BaseModel):
    ...
    def backward_G(self):
        ...
        # Difference loss ||(G_A(A_2)-G_A(A_1))-(A_2 - A_1)||
        self.loss_diff_A = self.criterionDif(self.diff_A, self.real_diff_A) * lambda_A * lambda_diff_s
        # Difference loss ||(G_B(B_2)-G_B(B_1))-(B_2 - B_1)||
        self.loss_diff_B = self.criterionDif(self.diff_B, self.real_diff_B) * lambda_B * lambda_diff_t
        # combined loss and calculate gradients
