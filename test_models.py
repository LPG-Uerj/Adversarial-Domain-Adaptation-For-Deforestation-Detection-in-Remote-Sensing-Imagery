...
def test(source, target, args, global_args, models, file_name):
	...
	run_test = True
	prodes = args.prodes_polygon_removal
	...
	if hasattr(args, 'FS_on_adapted_target_only'):
		FS_on_adapted_target_only = args.FS_on_adapted_target_only
	else:
		FS_on_adapted_target_only = False
	if hasattr(args, 'FS_on_target_only'):
		FS_on_target_only = args.FS_on_target_only
	else:
		FS_on_target_only = False
	if hasattr(args, 'FS_on_source_only'):
		FS_on_source_only = args.FS_on_source_only
	else:
		FS_on_source_only = False

	test_only_on_proper_domain = args.test_only_on_proper_domain
	test_FS_models = args.test_FS_models
	test_FS_on_both_domains = args.test_FS_on_both_domains
